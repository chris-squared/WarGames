...
//			TicTacToeTurn turnState = new TicTacToeTurn(state,ticTacToeLogic); // initialize new game engine
...
//			while (turnState.nextPlayersTurn(turn,in)){ // ALternate turns and define methods in the engine.
